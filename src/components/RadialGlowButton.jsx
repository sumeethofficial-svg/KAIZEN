  ...
  return (
    <div className="relative inline-block">
      <style>{`
        ...
        @property --rg-color-1 {
          syntax: '<color>';
          initial-value: #160500;
          inherits: false;
        }

        @property --rg-color-2 {
          syntax: '<color>';
          initial-value: #5c1804;
          inherits: false;
        }

        @property --rg-color-3 {
          syntax: '<color>';
          initial-value: #d94b08;
          inherits: false;
        }

        @property --rg-color-4 {
          syntax: '<color>';
          initial-value: #ffad35;
          inherits: false;
        }

        @property --rg-color-5 {
          syntax: '<color>';
          initial-value: #090300;
          inherits: false;
        }
        ...
        @property --rg-border-color-1 {
          syntax: '<color>';
          initial-value: rgba(255, 215, 150, 0.72);
          inherits: true;
        }

        @property --rg-border-color-2 {
          syntax: '<color>';
          initial-value: rgba(255, 125, 40, 0.28);
          inherits: true;
        }
        ...
        .rg-button {
          ...
          --bg: radial-gradient(
            var(--rg-spread-x) var(--rg-spread-y)
            at var(--rg-pos-x) var(--rg-pos-y),
          ...
          transition:
            ...
            --rg-color-5 .75s,
            --rg-border-angle .75s,
            --rg-border-color-1 .75s,
            --rg-border-color-2 .75s,
            --rg-stop-1 .75s,
            --rg-stop-2 .75s,
            --rg-stop-3 .75s,
            --rg-stop-4 .75s,
          ...
          box-shadow:
            0 8px 30px rgba(255, 85, 10, 0.10);
        }
        ...
        .rg-button:hover {
          ...
          --rg-border-color-2:
            rgba(255, 110, 30, 0.65);

          --button-line-opacity: 1;

          box-shadow:
            0 10px 35px rgba(255, 75, 10, 0.18),
            0 0 20px rgba(255, 105, 20, 0.08);
        }
        ...
        .rg-button:active {
          ...
          box-shadow:
            0 5px 18px rgba(255, 75, 10, 0.16);
        }
        ...
        .rg-button:focus-visible {
          outline: 2px solid rgba(255, 190, 100, 0.75);
